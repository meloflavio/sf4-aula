 ...
 */
final class Version20190218172459 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contato ADD endereco_id INT DEFAULT NULL, CHANGE mensagem mensagem VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE contato ADD CONSTRAINT FK_C384AB421BB76823 FOREIGN KEY (endereco_id) REFERENCES endereco (id)');
        $this->addSql('CREATE INDEX IDX_C384AB421BB76823 ON contato (endereco_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_C384AB421BB76823 ON contato');
        $this->addSql('ALTER TABLE contato DROP endereco_id, CHANGE mensagem mensagem VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
    }
}
